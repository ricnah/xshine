...
export declare const makeMessagesRecvSocket: (config: SocketConfig) => {
    ...
    payloadEngine: import("./payload-engine.js").PayloadEngine;
    ...
    sendTable: (jid: string, title: string, headers: string[], rows: string[][], quoted?: any, options?: import("../Utils/index.js").FormattingMessageOptions) => Promise<{
        message: any;
        messageId: string;
    }>;
    sendList: (jid: string, title: string, items: (string | string[])[], quoted?: any, options?: import("../Utils/index.js").FormattingMessageOptions) => Promise<{
        message: any;
        messageId: string;
    }>;
    ...
    sendFormattedMessage: (jid: string, submessages: proto.IAIRichResponseSubMessage[], quoted?: any, options?: {}) => Promise<{
        message: any;
        messageId: string;
    }>;
