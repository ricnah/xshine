...
export var FormattingSubMessageType;
(function (FormattingSubMessageType) {
  FormattingSubMessageType[(FormattingSubMessageType["UNKNOWN"] = 0)] = "UNKNOWN";
  FormattingSubMessageType[(FormattingSubMessageType["GRID_IMAGE"] = 1)] = "GRID_IMAGE";
  FormattingSubMessageType[(FormattingSubMessageType["TEXT"] = 2)] = "TEXT";
  FormattingSubMessageType[(FormattingSubMessageType["INLINE_IMAGE"] = 3)] = "INLINE_IMAGE";
  FormattingSubMessageType[(FormattingSubMessageType["TABLE"] = 4)] = "TABLE";
  FormattingSubMessageType[(FormattingSubMessageType["CODE"] = 5)] = "CODE";
  FormattingSubMessageType[(FormattingSubMessageType["DYNAMIC"] = 6)] = "DYNAMIC";
  FormattingSubMessageType[(FormattingSubMessageType["MAP"] = 7)] = "MAP";
  FormattingSubMessageType[(FormattingSubMessageType["LATEX"] = 8)] = "LATEX";
  FormattingSubMessageType[(FormattingSubMessageType["CONTENT_ITEMS"] = 9)] =
    "CONTENT_ITEMS";
})(FormattingSubMessageType || (FormattingSubMessageType = {}));
...
export const buildFormattingContextInfo = (quoted) => {
  const ctxInfo = {
    forwardingScore: 1,
    isForwarded: true,
...
export const generateTableContent = (
  ...
  const ctxInfo = buildFormattingContextInfo(quoted);
  return {
...
export const generateFormattedContent = (submessages, quoted) => {
  const ctxInfo = buildFormattingContextInfo(quoted);
  return {
    message: buildBotForwardedMessage(submessages, ctxInfo),
    messageId: generateMessageIDV2(),
